/**
 * This is some old code that I wrote after asking Said if I could use OOP,
 * But later on, he said that I couldn't use OOP when I almost finished the game...
 * So I'm re-writing it, and keeping this temporarily as a reference to not "re-invent"
 * many of the already written algorithms.
 *
 * And yes, I know this will always be in the Git history, but I prefer to keep this locally
